...
// 📌 [Posts] 게시판(설정) 원본 타입
export type PrismaPostsInfo = Prisma.PostsGetPayload<{}>;
...
export const PostsUpsertSchema = z.object({
  ...
  postName: z.string().min(2, "게시판 이름을 입력해주세요."),
  postDesc: z.string().optional().nullable(),

...
import { savePostsInfo } from "@extentions/posts/_actions/posts.action";
import type { PostInfoData } from "@extentions/posts/_actions/_type";
...
const DashboardPostCreate = ({ initialData, groupList, pid }: {
  initialData: any;
  groupList: any[];
  pid: string;
}) => {

    ...
    <>
      ...
      <div className="flex justify-end gap-2 mx-auto max-w-screen-md py-8">
        <Button
          type="button"
          fullWidth={false}
          onClick={() => router.push(`/posts/${postInfo.pid}`)}
        ...
        {user?.id === document.userId && (
          <>
            <Button
              type="button"
              fullWidth={false}
              onClick={() => router.push(`/posts/${postInfo.pid}/${document.id}/edit`)}
            ...
            <Button
              type="button"
              fullWidth={false}
              onClick={() => router.push(`/posts/${postInfo.pid}/${document.id}/delete`)}

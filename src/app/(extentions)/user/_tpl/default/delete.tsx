...
import HeaderUser from "@extentions/user/_tpl/default/header";

// 🌟 비밀번호 확인 액션과, 탈퇴 액션을 모두 불러옵니다.
import { removeMyAccount, verifyMyPassword } from "@extentions/user/_actions/user.action";
import { UserInfo } from "@extentions/user/_actions/_type";

...
import DashboardPostCreate from "@extentions/posts/_admin/create";
import PostCategory from "@extentions/posts/_admin/components/postCategory";
import { getPostsInfoById } from "@extentions/posts/_actions/posts.action";
import { getGroups } from "@extentions/user/_actions/group.action";

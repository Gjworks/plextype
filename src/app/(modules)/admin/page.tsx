      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="grid grid-cols-12 gap-6 max-w-[1920px] mx-auto">
        ...
        <div className="col-span-12 lg:col-span-3 space-y-12">
          ...
          <section className="p-6 bg-gray-100 rounded-xl border border-gray-200">
            ...
            <button onClick={() => addToast('인사이트를 갱신했습니다.', 'success')} className="w-full py-2 bg-white rounded-lg text-[11px] font-bold shadow-sm hover:shadow-md transition-all active:scale-95">
              Refresh Insight
            </button>
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex gap-2">
        <button onClick={triggerRandomToast} className="flex-1 flex items-center justify-center gap-2 py-2 bg-zinc-900 text-white rounded-lg text-[10px] font-bold hover:bg-zinc-800 transition-all active:scale-95">
          RANDOM
        </button>
        <button onClick={() => addToast('성공!', 'success')} className="px-3 py-2 bg-blue-50 text-blue-600 rounded-lg border border-blue-100 hover:bg-blue-100">
          ㅇㄴ
        </button>
      </div>
    </div>

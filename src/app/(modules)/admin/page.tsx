      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="grid grid-cols-12 gap-6 max-w-[1920px] mx-auto">
        ...
        <div className="col-span-12 lg:col-span-3  space-y-6">
          <section className="space-y-8 bg-white/80 p-8 rounded-xl shadow-lg shadow-gray-100">
            ...
            <div className="text-sm font-medium text-gray-500 uppercase tracking-[0.012em]">Recent Documents</div>
            <DocumentList />
          </section>
          <section className="space-y-8 bg-white/80 p-8 rounded-xl shadow-lg shadow-gray-100">
            <p className="text-[9px] font-bold uppercase tracking-[0.012em] text-gray-400 mb-1">Community</p>
            <div className="text-sm font-medium text-gray-500 uppercase tracking-[0.012em]">Recent Comments</div>
            <CommentList />
          </section>
        </div>
        ...
        <div className="col-span-12 lg:col-span-6 space-y-6">
          <section className="bg-white rounded-2xl p-10 shadow-lg shadow-gray-100 flex flex-col">

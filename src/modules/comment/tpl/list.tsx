                  ...
                  {!c.isDeleted && (currentUser?.isAdmin || currentUser?.id === c.userId) && (
                    <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="inline-flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-gray-100 text-gray-500 transition-colors duration-200 hover:bg-gray-200 hover:text-gray-800 dark:bg-dark-800 dark:text-dark-300 dark:hover:bg-dark-700 dark:hover:text-dark-100"
                        aria-label="댓글 수정"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-red-50 text-red-400 transition-colors duration-200 hover:bg-red-100 hover:text-red-600 dark:bg-red-400/10 dark:text-red-300 dark:hover:bg-red-400/15 dark:hover:text-red-200"
                        aria-label="댓글 삭제"
                      >

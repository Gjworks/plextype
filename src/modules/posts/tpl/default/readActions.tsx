      ...
      {canEdit && (
        <>
          ...
          <Button
            ...
            className="min-w-20 border-red-500/25 !px-5 !py-2 text-red-500 hover:border-red-500/35 hover:!bg-red-50 hover:!text-red-600 hover:ring-red-100/70 dark:border-red-400/20 dark:text-red-300 dark:hover:!bg-red-400/10 dark:hover:!text-red-200 dark:hover:ring-red-400/10"
          >
            삭제
          </Button>
        </>
